...
public class Character : MonoBehaviour
{
   ...
   // public TextMeshProUGUI statusText;//serve davvero?
    ...
    public int earthAtk;
    public int earthDef;
    //Queste forse non servono, i singoli script o le animazioni risolvono
    //public float walkSpeed;
    //public float runSpeed;
    //public float atkSpeed;
    [SerializeField] private float canTakeDamageAgainTimer = 1f;
    ...
    {
        yield return new WaitForSeconds(canTakeDamageAgainTimer);//aggiunta una variabile
        damageTaken = 0;
    }
}
